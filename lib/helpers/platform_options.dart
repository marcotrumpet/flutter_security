...
class IosSecurityOptions extends PlatformSecurityOptions
  ...
  ///
  /// [cryptographicKey] is the key used to encrypt the json. If you're using the script attached in the readme https://github.com/ziomarco/mobile-security-hashgenerator the default length is 32 characters. Required for 'hasBundleBeenCompromised' method.
  ///
